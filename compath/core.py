...
"""
COMPATH.CORE: Core classes and functions.
...
from compath import Error
from compath.mask import add_region, apply_mask
from compath.magnif import Magnification
from typing import NewType, Dict, Iterable, Optional
...
class MRI(object):
    ...
    def get_polygonal_region_px(self, contour: shg.Polygon, level: int,
        ...
        add_region(mask, np.array(contour.exterior.coords.xy).T)
